...
import { Modal, ModalOverlay, ModalContent, useTheme } from '@chakra-ui/react'

function BookingModal({ url, isOpen, onClose }) {
    ...
    <>
      <Modal isOpen={isOpen} onClose={onClose} size="full" closeOnOverlayClick={false}>
        ...
        <ModalContent marginY={0} marginX="auto" minHeight="100vh" maxWidth={theme.breakpoints.lg}>
          <iframe title="Booking Engine" style={{ height: '100vh', width: '100%' }} src={url} />
        </ModalContent>
      </Modal>
    </>
  )
